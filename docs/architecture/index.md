...
- [GeuseMaker Architecture Document](#table-of-contents)
  ...
  - [5. Components](./5-components.md)
    - [5.1 CLI Layer](./5-components.md#51-cli-layer)
      - [5.1.1 ASCII Art & Branding](./5-components.md#511-ascii-art--branding-geusemakerclibrandingpy)
  ...
  - [9. Source Tree](./9-source-tree.md)
    - [9.1 Ownership boundaries](./9-source-tree.md#91-ownership-boundaries)
    - [9.2 Important entry points](./9-source-tree.md#92-important-entry-points)
    - [9.3 Import direction](./9-source-tree.md#93-import-direction)
    - [9.4 Repository hygiene](./9-source-tree.md#94-repository-hygiene)
